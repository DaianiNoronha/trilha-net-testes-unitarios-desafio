# 🖥️ DIO - Trilha .NET - Testes Unitários com C#

www.dio.me

Este é um Desafio de Projeto em C# realizado com conhecimentos adquiridos no módulo de Testes Unitários com C#, da trilha .NET da DIO.
...
O código de testes está pela metade, e você deverá dar continuidade implementando os testes descritos acima, para que no final, tenhamos um programa de testes funcional.
